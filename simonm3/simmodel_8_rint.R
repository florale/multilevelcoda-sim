...
set.seed(8) 
sampled_cond <- cond[140001:160000] 
...
starttime <- proc.time()
out8_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out8_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out8_rint, "out8_rint.RDS")