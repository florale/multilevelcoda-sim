...
set.seed(6) 
sampled_cond <- cond[100001:120000] 
...
starttime <- proc.time()
out6_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out6_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out6_rint, "out6_rint.RDS")