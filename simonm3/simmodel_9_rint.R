...
set.seed(9) 
sampled_cond <- cond[160001:180000] 
...
starttime <- proc.time()
out9_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out9_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out9_rint, "out9_rint.RDS")