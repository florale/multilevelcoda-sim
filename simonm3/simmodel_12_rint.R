...
set.seed(12) 
sampled_cond <- cond[220001:240000] 
...
starttime <- proc.time()
out12_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out12_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out12_rint, "out12_rint.RDS")