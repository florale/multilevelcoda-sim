...
out <- readRDS("/fs04/ft29/simonm3/out24.RDS")
...
simsum_sub_24 <- list(sub_sum3, sub_sum4, sub_sum5)
names(simsum_sub_24) <- c("out3", "out4", "out5")
saveRDS(simsum_sub_24, "simsum_sub_24.RDS")