...
out <- readRDS("/fs04/ft29/simonm3/out13.RDS")
...
simsum_sub_13 <- list(sub_sum3, sub_sum4, sub_sum5)
names(simsum_sub_13) <- c("out3", "out4", "out5")
saveRDS(simsum_sub_13, "simsum_sub_13.RDS")