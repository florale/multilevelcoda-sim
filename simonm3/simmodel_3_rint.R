...
starttime <- proc.time()
out3_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out3_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out3_rint, "out3_rint.RDS")