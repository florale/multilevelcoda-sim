...
starttime <- proc.time()
out5_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out5_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out5_rint, "out5_rint.RDS")