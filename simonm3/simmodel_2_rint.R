...
starttime <- proc.time()
out2_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out2_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out2_rint, "out2_rint.RDS")