...
set.seed(7) 
sampled_cond <- cond[120001:140000] 
...
starttime <- proc.time()
out7_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out7_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out7_rint, "out7_rint.RDS")