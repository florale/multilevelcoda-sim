...
set.seed(10) 
sampled_cond <- cond[180001:200000] 
...
starttime <- proc.time()
out10_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out10_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out10_rint, "out10_rint.RDS")