...
out <- readRDS("/fs04/ft29/simonm3/out22.RDS")
...
simsum_sub_22 <- list(sub_sum3, sub_sum4, sub_sum5)
names(simsum_sub_22) <- c("out3", "out4", "out5")
saveRDS(simsum_sub_22, "simsum_sub_22.RDS")