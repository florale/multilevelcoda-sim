...
starttime <- proc.time()
out4_rint <- vector("list", length = nrow(sampled_cond))
sim_model <- list()

out4_rint <- foreach(i = seq_len(nrow(sampled_cond)),
...
saveRDS(out4_rint, "out4_rint.RDS")