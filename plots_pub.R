...
png("brmcoda_cover_d4.png", width = 14, height = 15, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
sub_par_d4 <-
  ...
  geom_text(aes(x = 0,
            ...
            hjust = 0) +
  xlim(-0.0, .2)  +
  geom_text(aes(label = "Estimand", y = 13, x = 0,
                family = font),
            fontface = "bold",
            color = "black", vjust = "inward", hjust = 0) +
  scale_x_discrete(drop = FALSE) +
...
png("sub_bias_d4.png", width = 13, height = 18, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
png("sub_cover_d4.png", width = 13, height = 18, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
png("brmcoda_bias_d3.png", width = 14, height = 14, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
png("brmcoda_cover_d3.png", width = 14, height = 14, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
png("sub_bias_d3.png", width = 13, height = 15, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
...
png("sub_cover_d3.png", width = 13, height = 15, units = 'in', res = 900)
ggarrange(p1, p2, p3, p4,
          nrow = 4)
dev.off()
