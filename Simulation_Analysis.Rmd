...
out<- readRDS("out_foreach10_ll_brms.RDS") # result
...
for (i in 1:length(out)) {
  if (identical(out[[i]][[8]], c("Sleep", "PA", "SB"))) out3[[i]] <- out[[i]]
  if (identical(out[[i]][[8]], c("Sleep", "MVPA", "LPA", "SB"))) out4[[i]] <- out[[i]]
  if (identical(out[[i]][[8]], c("TST", "WAKE", "MVPA", "LPA", "SB"))) out5[[i]] <- out[[i]]
}
